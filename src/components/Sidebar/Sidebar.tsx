	...
	return (
		<aside className='flex flex-col justify-between items-center w-max h-screen'>
			<div className='flex flex-col items-center'>
				<WingsterLogo />
                <HouseIcon isSelected={Icons.House === currentIcon} iconStyles={iconStyles} />
                <OrderIcon isSelected={Icons.Order === currentIcon} iconStyles={iconStyles} />
                <TenderIcon isSelected={Icons.Order === currentIcon} iconStyles={iconStyles} />
