	...
	return (
		<aside className='flex flex-col justify-between items-center w-max h-screen'>
			<div className='flex flex-col items-center'>
				<WingsterLogo />
				<HouseIcon isSelected={SelectedIcons.House === currentIcon} iconStyles={iconStyles} />
				<OrderIcon isSelected={SelectedIcons.Order === currentIcon} iconStyles={iconStyles} />
				<TenderIcon isSelected={SelectedIcons.Order === currentIcon} iconStyles={iconStyles} />
